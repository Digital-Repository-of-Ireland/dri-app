...
There's no debian package for fits so you'll need to get it from 
the harvard website https://projects.iq.harvard.edu/fits/downloads
or github https://github.com/harvard-lts/fits/
