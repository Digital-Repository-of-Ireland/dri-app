...
be set to the (relative) path to the Irish yml file. For example:

  $ rake localefiles file=config/locales/dri/ga.yml

This will merge any new keys from the English file into the Irish one with
the English text.
