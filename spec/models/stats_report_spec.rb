...
describe StatsReport do
  ...
  context "Mime_type stats" do
    it "should return mime type counts" do
      generic_file1 = DRI::GenericFile.new(id: Noid::Rails::Service.new.mint)
      generic_file1.batch = @object
      generic_file1.mime_type = "application/pdf"
      generic_file1.save

      generic_file2 = DRI::GenericFile.new(id: Noid::Rails::Service.new.mint)
      generic_file2.batch = @object
      generic_file2.mime_type = "image/jpeg"
      generic_file2.save

      generic_file3 = DRI::GenericFile.new(id: Noid::Rails::Service.new.mint)
