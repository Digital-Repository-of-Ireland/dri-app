...
describe InstitutesController do
  ...
  describe "associate" do
    ...
    it "should associate a depositing institute" do
      post :associate, params: { object: @collection.noid, institute_name: @institute.name, type: "depositing" }
  ...
  describe "disassociate" do
    ...
    it "should remove an association" do
      ...
      delete :disassociate, params: { object: @collection.noid, institute_name: @institute.name }
