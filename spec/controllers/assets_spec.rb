...
describe AssetsController do
  ...
  describe 'create' do
    ...
    it 'should create an asset from a local file' do
      ...
      post :create, params: { object_id: object.id, local_file: "SAMPLEA.mp3", file_name: "SAMPLEA.mp3" }
    ...
    it 'should create an asset from an upload' do
      ...
      post :create, params: { object_id: object.id, Filedata: uploaded }
   ...
   describe 'update' do
    it 'should create a new version' do
      ...
      uploaded = Rack::Test::UploadedFile.new(File.join(fixture_path, "SAMPLEA.mp3"), "audio/mp3")
      put :update, params: { object_id: object.id, id: file_id, Filedata: uploaded }
    ...
    it 'should create a new version from a local file' do
      ...
      put :update, params: { object_id: object.id, id: file_id, local_file: "SAMPLEA.mp3", file_name: "SAMPLEA.mp3" }
      expect(Dir.glob("#{tmp_assets_dir}/**/v0002/data/content/*_SAMPLEA.mp3")).not_to be_empty
    end
  ...
  describe 'destroy' do
    ...
    it 'should delete a file' do
      ...
      expect {
        delete :destroy, params: { object_id: object.id, id: file_id }
  ...
  describe 'download' do
    ...
    it "should be possible to download the master asset" do
      ...
      get :download, params: { id: file_id, object_id: object.id, type: 'masterfile' }
  ...
  describe 'list_assets' do
    ...
    it "should return a list of asset information" do
      ...
      post :list_assets, params: { objects: [ { "pid" => "#{object.id}" } ] }
