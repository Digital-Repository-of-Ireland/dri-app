...
Background:
  ...
  Given a Digital Object with pid "123456789", title "Object 1" created by "user1"
  And a collection with pid "coll1" created by "user1@user1.com"
  When I add the Digital Object "123456789" to the collection "coll1" as type "governing"
  And I go to the "object" "show" page for "123456789"
  And I add the asset "sample_audio.mp3" to "123456789"
  And the object with pid "coll1" has status published
  And the object with pid "123456789" has status published
  Then the collection "coll1" should contain the Digital Object "123456789" as type "governing"
  Given I am not logged in


Scenario: Export DigitalObject's metadata
  When I go to the "object" "show" page for "123456789"
