...
Scenario: I should see the surrogate when the master file is not accessible
  Given a collection with pid "@random" and title "Access Controls Test Collection" created by "user1"
  And a Digital Object with pid "@random" and title "Access Controls Test Object" created by "user1"
  And the object with pid "@random" is governed by the collection with pid "@random"
  And the object with pid "@random" is publicly readable
  And the object with pid "@random" has "inaccessible" masterfile
  And the object with pid "@random" has a deliverable surrogate file
  And the object with pid "@random" is published
  And I am not logged in
  When I go to "show Digital Object page for id @random"
...
Scenario: I should see no files message when master file is not accessible and surrogates not yet created
  ...
  And a Digital Object with pid "dri:o44444" and title "Access Controls Test Object" created by "user1"
...
Scenario Outline: When I do have access by group or id then I should see the asset file
  ...
  And a Digital Object with pid "dri:o55555" and title "Access Controls Test Object" created by "user1"
...
Scenario: When I do not have access by group or id then I should not see the asset file
  ...
  And a Digital Object with pid "dri:o66666" and title "Access Controls Test Object" created by "user1"
...
Scenario: I should not see an object that is in draft status
  ...
  And a Digital Object with pid "dri:o77777" and title "Access Controls Test Object" created by "user1"
...
Scenario: I should see the object in search when it is public discoverable (metadata)
  ...
  And a Digital Object with pid "dri:o88888" and title "Access Controls Test Object" created by "user1"
...
Scenario: I should not see the object in search when it is published but parent colleciton is draft
  Given a collection with pid "dri:c99999" and title "Access Controls Test Collection" created by "user1"
  And a Digital Object with pid "dri:o99999" and title "Access Controls Test Object" created by "user1"
