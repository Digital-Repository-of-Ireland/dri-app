...
Scenario Outline: Faceted Search
  Given a collection with pid "dri:test" and title "Test collection"
  And an object in collection "dri:test" with metadata from file "SAMPLEA.xml"
