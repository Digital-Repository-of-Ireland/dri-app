...
edit permission.
  ...
  Scenario: Admin user can see all objects
    ...
    And a Digital Object with pid "dri:obj1" and title "Search Object 1" created by "user1@user1.com"
  ...
  Scenario: Collection managers should see all of their collections and objects within their collections
    ...
    And a Digital Object with pid "dri:obj2" and title "Search Object 2" created by "user1@user1.com"
  ...
  Scenario Outline: Manage/edit users should see all objects in collections for which they have permission
    ...
    And a Digital Object with pid "dri:obj4" and title "Search Object 4" created by "user1@user1.com"
  ...
  Scenario Outline: Manage/edit users should see all objects for which they have permission
    ...
    And a Digital Object with pid "dri:obj5" and title "Search Object 5" created by "user1@user1.com"
