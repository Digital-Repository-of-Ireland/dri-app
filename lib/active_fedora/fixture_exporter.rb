# Patched version of activefedora's fixture exporter to handle a change in the
# Rubydora api. When we upgrade activefedora this should go away.
...
module ActiveFedora
  module FixtureExporter
    ...
    def self.export(pid, extra_params={})
      ...
      ActiveFedora::Base.connection_for_pid(pid).api.export(:pid=>pid, :format=>format, :context=>extra_params[:context].to_s)
    end
