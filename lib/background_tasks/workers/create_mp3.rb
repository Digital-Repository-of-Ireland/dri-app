class CreateMp3
  ...
  def self.perform(object_id)
    ...
    begin
      AWS::S3::S3Object.store("#{@object.pid}-Surrogate.mp3", open(outputfile), bucket, :access => :public_read)
...
#    @object.add_file_reference("mp3Surrogate", {:url => outputfile, :mimeType => "audio/mpeg3"})
#    @object.save
