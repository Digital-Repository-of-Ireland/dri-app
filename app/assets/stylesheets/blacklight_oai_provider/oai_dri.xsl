...
<xsl:variable name="prefix" select="/oai:OAI-PMH/oai:request/@metadataPrefix" />
...
<xsl:template name="quicklinks">
    <ul class="quicklinks">
      ...
      <li><a href="?verb=ListRecords&amp;metadataPrefix={$prefix}">ListRecords</a> | </li>
      <li><a href="?verb=ListSets">ListSets</a> | </li>
      <li><a href="?verb=ListMetadataFormats">ListMetadataFormats</a> | </li>
      <li><a href="?verb=ListIdentifiers&amp;metadataPrefix={$prefix}">ListIdentifiers</a></li>
    </ul>
</xsl:template>
...
<xsl:template match="oai:setSpec">
  ...
  <td class="value"><xsl:value-of select="."/>
    <xsl:text> </xsl:text><a class="link" href="?verb=ListIdentifiers&amp;metadataPrefix=oai_dri&amp;set={.}">Identifiers</a>
    <xsl:text> </xsl:text><a class="link" href="?verb=ListRecords&amp;metadataPrefix=oai_dri&amp;set={.}">Records</a>
  </td></tr>
</xsl:template>
...
<xsl:template match="oai_dri:dri"  xmlns:oai_dri="https://repository.dri.ie/oai_dri/" >
  <div class="dcdata">
    <h3>DRI Metadata (oai_dri)</h3>
    <table class="dcdata">
      <xsl:apply-templates select="*" />
    </table>
  </div>
...
<xsl:template match="dcterms:spatial" xmlns:dcterms="http://purl.org/dc/terms/">
<tr><td class="key">Spatial</td><td class="value"><xsl:value-of select="."/></td></tr></xsl:template>
...
<tr><td class="key">isPartOf</td><td class="value"><xsl:value-of select="."/></td></tr></xsl:template>

<xsl:template match="dcterms:license" xmlns:dcterms="http://purl.org/dc/terms/">
<tr><td class="key">License</td><td class="value"><xsl:value-of select="."/></td></tr></xsl:template>

<xsl:template match="edm:provider" xmlns:edm="http://www.europeana.eu/schemas/edm/">
<tr><td class="key">Provider</td><td class="value"><xsl:value-of select="."/></td></tr></xsl:template>

<xsl:template match="edm:dataProvider" xmlns:edm="http://www.europeana.eu/schemas/edm/">
<tr><td class="key">Data Provider</td><td class="value"><xsl:value-of select="."/></td></tr></xsl:template>

<xsl:template match="edm:isShownAt" xmlns:edm="http://www.europeana.eu/schemas/edm/">
<tr><td class="key">isShownAt</td><td class="value">
  <xsl:choose>
    <xsl:when test='starts-with(.,"http" )'>
      <xsl:choose>
        <xsl:when test='string-length(.) &gt; 50'>
