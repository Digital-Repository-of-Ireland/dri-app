module DRI::IIIFViewable
  ...
  def attached_images(solr_id = nil)
    ...
    files_query += " AND isPartOf_ssim:#{solr_id}"
    ...
    files.sort_by{ |f| f[Solr::SchemaFields.searchable_string('label')] }
  end
