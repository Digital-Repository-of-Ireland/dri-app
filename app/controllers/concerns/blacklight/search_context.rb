...
module Blacklight::SearchContext
  ...
  def set_current_search_session
    search_session['params'] = current_search_session if current_search_session
  end
  ...
  def find_search_session
    ...
    elsif search_session['params']
      find_or_initialize_search_session_from_params search_session['params']
    end
  end
  ...
  def setup_next_and_previous_documents
    if search_session['counter'] && current_search_session
      ...
      response, documents = search_service.previous_and_next_documents_for_search index, search_state.reset(current_search_session['params'])
