Blacklight::SearchState.class_eval do
 # @param [ActionController::Parameters] params
    ...
    def filter(field_key_or_field)
      ...
      (field.filter_class || Blacklight::SearchState::FilterField).new(field, self)
    end
    ...
    def params_for_search(params_to_merge = {})
      ...
      Blacklight::Parameters.sanitize(my_params)
    end
    ...
    def reset_search_params
      Blacklight::Parameters.sanitize(params).except(:page, :counter)
    end
end
